...
public class DisponibilidadeController {
    ...
    public DisponibilidadeResponse criar(@Valid @RequestBody CreateDisponibilidadeRequest request) {
        return disponibilidadeService.criar(request);
    }
    ...
    @GetMapping("/{id}")
    public DisponibilidadeResponse buscarPorId(@PathVariable Long id) {
