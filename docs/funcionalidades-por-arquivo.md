...
- `lib/pages/search.dart`
  ...
  - toque em recente ou sugestao aplica texto ou leva para resultado/prestador conhecido
...
- `lib/pages/search_results.dart`
  ...
  - toque em estabelecimento interno ou CTA `Servicos disponiveis` abre `ServicePage` do prestador correto
